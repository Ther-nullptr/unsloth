...
def MistralAttention_fast_forward( #! This way
    ...
    *args, **kwargs,
    ...
    if (not HAS_FLASH_ATTENTION and attention_mask is None):
        ...
        A = efficient_flash_attn_func(Q, K, V, causal = True, window_size = window, iteration=self.iteration, calibration_step=self.calibration_step, register_target=self, softcap=0.0)
        self.iteration += 1
    else:
