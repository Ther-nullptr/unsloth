...
def _cross_entropy_forward(
    ...
    if DO_SOFTCAPPING: logits = SOFTCAP * tl.extra.cuda.libdevice.tanh(logits / SOFTCAP)
    ...
    if label_idx != -100:
        ...
        # Do logit softcapping for Gemma 2: t * tanh(1/t * x)
        if DO_SOFTCAPPING: x = SOFTCAP * tl.extra.cuda.libdevice.tanh(x / SOFTCAP)
...
def _cross_entropy_backward(
    ...
    if DO_SOFTCAPPING:
        ...
        partial = tl.extra.cuda.libdevice.tanh(x / SOFTCAP)
        x = SOFTCAP * partial
    pass
